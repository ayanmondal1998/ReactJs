         ...
         <div id="wrapper">
            ...
            <div className="container">
               <div className="stepProgressPanel">
                  <p className="leadTitle pt-3"  align="center">Electronic signature of the Easy Payment Newsletter</p>
               ...
               <div className="content_panel">
                  <div className="px-3">
                     <p className="innerLeadText">Your application for the pension contract has been accepted by the ICMR</p>
                     <p className="">Please sign the Easy Payment newsletter electronically</p>
                     <div className="row row-cols-1 row-cols-lg-3 g-4">
                        <div className="col">
                           <div className="card customCard">
                              <div className="card-body">
                                 <h6 className="card-title">Pension Contract Reference</h6>
                                 <a href="#/" className="btn orangeBtn" data-bs-toggle="modal" data-bs-target="#membershipFileReference">Visualization</a>
                              </div>
                           </div>
                        </div>
                     </div>
                     <p className="innerLeadText mt-4">Electronic signature by banking delegate</p>
                     <div className="row row-cols-1 row-cols-lg-3 g-4">
                        <div className="col">
                           <div className="card customCard h-100">
                              <div className="card-body">
                                 <h6 className="card-title">Easy Payment Newsletter</h6>
                     ...
                     <div className="col-12 py-4">
                        <div className="form-group text-center">
                           <a href="ecran6_prospect_fo.html" className="btn orangeBtn" >Return</a>
                           <a href="#/" className="btn orangeBtn" >Validate</a>
                        </div>
                     </div>
                  </div>
               </div>
         ...
         <div className="modal-dialog">
            <div className="modal-content">
               ...
               <div className="modal-header">
                  <h6 className="modal-title">Pension Contract Reference</h6>
