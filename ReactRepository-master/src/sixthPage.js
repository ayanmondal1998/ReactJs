         ...
         <div id="wrapper">
            ...
            <div className="container">
               <div className="stepProgressPanel">
                  <p className="leadTitle pt-3"  align="center">Electronic Signature of Retirement Contract</p>
               ...
               <div className="content_panel">
                  <div className="px-3">
                     ...
                     <p className="">Please proceed to the electronic signing of the pension contract</p>
                     ...
                     <div className="row row-cols-1 row-cols-lg-3 g-4">
                        <div className="col">
                           <div className="card customCard h-100">
                              <div className="card-body">
                                 <h6 className="card-title">Retirement Contract</h6>
                     ...
                     <div className="col-12 py-4">
                        <div className="form-group text-center">
                           <a href="ecran5_prospect_fo.html" className="btn orangeBtn" >Return</a>
                           <a href="ecran7_prospect_fo.html" className="btn orangeBtn" >Validate</a>
                        </div>
                     </div>
                  </div>
               </div>
