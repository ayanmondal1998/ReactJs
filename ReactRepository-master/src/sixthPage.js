         ...
         <div id="wrapper">
            ...
            <div class="container">
               <div class="stepProgressPanel">
                  <p class="leadTitle pt-3"  align="center">Electronic Signature of Retirement Contract</p>
               ...
               <div class="content_panel">
                  <div class="px-3">
                     ...
                     <p class="">Please proceed to the electronic signing of the pension contract</p>
                     ...
                     <div class="row row-cols-1 row-cols-lg-3 g-4">
                        <div class="col">
                           <div class="card customCard h-100">
                              <div class="card-body">
                                 <h6 class="card-title">Retirement Contract</h6>
                     ...
                     <div class="col-12 py-4">
                        <div class="form-group text-center">
                           <a href="ecran5_prospect_fo.html" class="btn orangeBtn" >Return</a>
                           <a href="ecran7_prospect_fo.html" class="btn orangeBtn" >Validate</a>
                        </div>
                     </div>
                  </div>
               </div>
